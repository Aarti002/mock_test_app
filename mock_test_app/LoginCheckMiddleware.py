...
class LoginCheckMiddleWare(MiddlewareMixin):
    def process_view(self,request,view_func,view_args,view_kwargs):
        ...
        if user.is_authenticated:
            if user.user_type == "1":
                if modulename == "mock_test_app.Adminviews":
                    pass
                elif modulename == "mock_test_app.views" or modulename == "django.views.static":
                    pass
                ...
                if modulename == "mock_test_app.Participantviews":
                    pass
                elif modulename == "mock_test_app.views" or modulename == "django.views.static":
                    pass
                else:
